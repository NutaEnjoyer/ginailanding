...
const faqs = [
  ...
  { q: "Что нужно подготовить до старта проекта?", a: "На первом этапе достаточно понимания задачи. Мы сами поможем с формализацией, подбором инструментов и проанализируем, где ИИ даст выгоду, а где — избыточен. Если у вас есть данные (базы клиентов, документы, логи) — это ускорит процесс, но не обязательно на старте." },
